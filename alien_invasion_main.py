...
def run_game():
    ...
    while True:
        ...
        if stats.game_active:
            ...
            gf.update_bullets(ai_settings, screen, stats, scoreboard_, ship, aliens, bullets, sounds, explosion)
            gf.update_aliens(ai_settings, screen, stats, scoreboard_, ship, aliens, bullets)

        gf.update_screen(ai_settings, screen, stats, scoreboard_, ship, bullets, aliens, play_button, stars, explosion)
