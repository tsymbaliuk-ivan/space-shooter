...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        self.high_score_rect.centerx = self.screen_rect.centerx  # выравнивание прямоугольника по центру экрана
        self.high_score_rect.top = self.score_rect.top

    def prep_level(self):
        """Преобразует уровень в графическое изображение."""
        # изображение на базе значения, хранящегося в stats.level
        ...
        # атрибут top сдвигается на 10 пикселов ниже нижнего края
        # изображения текущего счета, чтобы между счетом и уровнем оставался пустой интервал
        self.level_rect.right = self.score_rect.right
